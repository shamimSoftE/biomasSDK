...
class Check extends CI_Controller
{
	...
	public function check_entry_page()
	{
		...
		$data['banks']  = $this->db->select('account_id,account_name,account_number,bank_name,branch_name, status')->where('branch_id', $this->branch_id)->where('status', 1)->get('tbl_bank_accounts')->result();
	...
	public function check_date_store()
	{
		...
		$this->form_validation->set_rules('account_id', 'Bank Account Name', 'required|trim');
