...
class Invest extends CI_Controller
{
    ...
    public function getInvestmentTransactions()
    {
        ...
        $transactions = $this->db->query("
            ...
            left join tbl_investment_account ac on ac.Acc_SlNo = lt.account_id
            left join tbl_user u on u.User_SlNo = lt.AddBy
            left join tbl_bank_accounts ba on ba.account_id = lt.bank_account_id
            where lt.status = 1
            and lt.branch_id = ?
            $clauses
