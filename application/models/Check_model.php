...
class Check_model extends CI_Model
{
	...
	{	
		$this->db->select('tbl_cheque.*,tbl_customer.Customer_Name,tbl_customer.Customer_Code,tbl_supplier.Supplier_Name,tbl_supplier.Supplier_Code,tbl_bank_accounts.bank_name as account_bank_name,tbl_bank_accounts.account_number,tbl_bank_accounts.branch_name as bank_branch_name');
		$this->db->from('tbl_cheque');
		$this->db->join('tbl_customer', 'tbl_cheque.cus_id = tbl_customer.Customer_SlNo','left');
		$this->db->join('tbl_supplier', 'tbl_cheque.sup_id = tbl_supplier.Supplier_SlNo','left' );
		$this->db->join('tbl_bank_accounts', 'tbl_cheque.account_id = tbl_bank_accounts.account_id','left');
	...
	{	
		$this->db->select('tbl_cheque.*, tbl_customer.Customer_Name ,tbl_customer.Customer_Code,tbl_supplier.Supplier_Name,tbl_supplier.Supplier_Code,ba.bank_name as account_bank_name,ba.account_number,ba.branch_name as bank_branch_name');
		$this->db->from('tbl_cheque');
		$this->db->join('tbl_customer', 'tbl_cheque.cus_id = tbl_customer.Customer_SlNo','left');
		$this->db->join('tbl_supplier', 'tbl_cheque.sup_id = tbl_supplier.Supplier_SlNo','left' );
		$this->db->join('tbl_bank_accounts ba', 'tbl_cheque.account_id = ba.account_id','left');
	...
	{	
		$this->db->select('tbl_cheque.*, tbl_customer.Customer_Name ,tbl_customer.Customer_Code,tbl_supplier.Supplier_Name,tbl_supplier.Supplier_Code');
		$this->db->from('tbl_cheque');
		$this->db->join('tbl_customer', 'tbl_cheque.cus_id = tbl_customer.Customer_SlNo','left');
		$this->db->join('tbl_supplier', 'tbl_cheque.sup_id = tbl_supplier.Supplier_SlNo','left' );
	...
	{
		$attr = array(
			'cus_id'       => $this->input->post('type') == 'customer' ? $this->input->post('cus_id'):null,
			'sup_id'       => $this->input->post('type') == 'supplier' ?$this->input->post('sup_id'):null,
