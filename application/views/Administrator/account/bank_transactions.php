...
<div id="bankTransactions">
    ...
    <div class="row" style="margin: 0;">
        <fieldset class="scheduler-border">
            <legend class="scheduler-border">Bank Transaction Form</legend>
                        ...
                        <tr v-bind:class="[row.transaction_type == 'deposit' ? 'transaction-deposit' : 'transaction-withdraw']">
                            ...
                            <td>
                                <?php if ($this->session->userdata('accountType') != 'u') { ?>
                                    <i class="btnEdit fa fa-pencil" @click="editTran(row)"></i>
    ...
    new Vue({
        ...
        created() {
            ...
            if (this.transaction.transaction_id != 0) {
               this.editTransaction(this.transaction.transaction_id);
            }
        },
        methods: {
            getAccounts() {
            ...
            editTran(row){
                window.open('/bank_transactions/' + row.transaction_id, '_blank');
            },

            editTransaction(transactionId) {
                axios.post('/get_bank_transactions',{transactionId: transactionId})
                .then(res => {
