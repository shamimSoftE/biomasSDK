    ...
    <div class="row">
        <div class="col-md-4">
            <div class="balance-section">
                ...
                <h3>Cash Balance</h3>
                <h1><?php echo $this->session->userdata('Currency_Name'); ?> 
                <?php echo number_format($transaction_summary->cash_balance, 2); ?>
            </h1>
            </div>
        </div>
                ...
                <div class="col-md-3 col-xs-6">
                    <div class="account-section">
                        ...
                        <div class="col2">
                            ...
                            <h3><?php echo $this->session->userdata('Currency_Name'); ?> 
