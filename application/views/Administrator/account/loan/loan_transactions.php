...
<div id="loanTransactions">
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Loan Transaction Form</legend>
        <div class="control-group">
            <form action="" class="form-horizontal" @submit.prevent="saveTransaction">
                <div class="row">
                    ...
                    <div class="col-md-3 text-center" style="display:none;" v-bind:style="{display: selectedAccount == null || selectedAccount.account_id == undefined ? 'none' : ''}">
    ...
    new Vue({
        ...
        methods: {
            ...
            resetForm() {
                ...
                this.transaction.payment_type = 'Cash';
