			...
			<div class="control-group">
				<form method="POST" id="assetsForm" action="#">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							<button type="button" class="btnSave pull-right" onclick="submitAssets()" name="btnSubmit">
								Submit
				...
				<form method="POST" id="assetsSaleForm" action="#">
					...
					<div class="form-group">
						...
						<div class="col-sm-8">
							...
							<select name="asset_name_id" id="s_assetsname" class="form-select" style="width: 100%; margin-bottom: 3px;">
								<option value="">select</option>
								<?php
								if (isset($asset_names) && $asset_names) {
									foreach ($asset_names as $row) { ?>
					...
					<div class="form-group">
						<label class="col-sm-3 control-label no-padding-right" for="form-field-1"></label>
						<div class="col-sm-8">
							<button type="button" class="btnSave pull-right" onclick="submitAssetsSale()" name="btnSubmit">
								Submit
								<i class="ace-icon fa fa-arrow-right icon-on-right bigger-110"></i>
							</button>
						</div>
