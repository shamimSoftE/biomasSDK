<?php if ($edit->buy_or_sale == 'buy') { ?>
    ...
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Asset Entry</legend>
            ...
            <form method="POST" id="assetsFormUpdate" action="#">
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        ...
                        <select name="asset_name_id" id="asset_name_id" class="form-select" style="width: 100%; margin-bottom: 3px;">
                            <option value="">select</option>
                            <?php
                            if (isset($asset_names) && $asset_names) {
                                foreach ($asset_names as $row) { ?>
                                    <option value="<?php echo $row->id; ?>" <?php if ($row->id == $edit->asset_name_id) { echo 'selected'; } ?> > <?php echo $row->name; ?></option>
                            <?php }
                            } ?>
                        </select>
                        <span id="error"></span>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-8">
                        <button type="button" class="btnSave pull-right" onclick="UpdateAssets(<?= $edit->as_id; ?>)" name="btnSubmit">
                            Submit
...
<?php } else { ?>
    <fieldset class="scheduler-border">
        <legend class="scheduler-border">Asset Sale</legend>
        <div class="control-group">
            <form method="POST" id="assetsSaleFormUpdate" action="#">
                ...
                <div class="form-group">
                    <label class="col-sm-3 control-label no-padding-right" for="form-field-1"></label>
                    <div class="col-sm-8">
                        <button type="button" class="btnSave pull-right" onclick="updateAssetsSale(<?= $edit->as_id; ?>)" name="btnSubmit">
                            Submit
                            <i class="ace-icon fa fa-arrow-right icon-on-right bigger-110"></i>
                        </button>
                    </div>
