            ...
            <div class="row">
              ...
              <div class="col-sm-4">
                  ...
                  <div class="col-sm-7">
                    <select class="select2 form-control" onchange="bankOnChange()" id="account_id" name="account_id" style="height: 30px; border-radius: 5px;">
                      ...
                      <?php if (isset($banks) && $banks) :  foreach ($banks as $bank) : ?>
                          <option value="<?= $bank->account_id; ?>" dataBranch="<?= $bank->branch_name; ?>">
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-7">
                    <input type="text" id="branch_name" name="branch_name" required readonly placeholder="Branch Name" class="form-control" />
                  </div>
                </div>
