...
<div class="content_scroll col-md-8 col-md-offset-2 col-xs-12">
        ...
        <div class="row" style="margin-bottom: 20px;">
            <div class="col-xs-7">
                <table style="width: 100%;">
                    <tr>
                        <td colspan="2" style="font-size: 13px; font-weight: 600; ">Customer ID : <?php echo $CPROW->Customer_Code; ?></td>
                    </tr>
                    <tr>
            ...
            <div class="col-xs-5">
                <table style="width: 100%;">
                    ...
                    <tr>
                        <td style="font-size: 13px; font-weight: 600;text-align:right; ">TR. Date: <?php echo $CPROW->CPayment_date; ?> </td>
                    </tr>
                </table>
            </div>
        </div>
