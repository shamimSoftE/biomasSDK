                ...
                <form class="form-horizontal" @submit.prevent="addDutyCosting">
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <label class="col-sm-1 control-label no-padding-right">:</label>
                            <div class="col-sm-7">
                                <v-select v-bind:options="invoices" label="invoice_text" v-model="selectedInvoice" v-on:input="getPurchaseProduct" placeholder="Select Invoice" disabled></v-select>
                            </div>
                        </div>
