...
?>
	<ul class="nav nav-list">
		...
		<li class="">
			<a href="<?php echo base_url(); ?>module/OrdersModule">
		...
		<li class="">
			<a href="<?php echo base_url(); ?>module/LcPurchaseModule">
				<i class="menu-icon fa fa-plane"></i>
				<span class="menu-text"> LC Module </span>
			</a>
			<b class="arrow"></b>
		</li>
			...
			<li class="<?= current_url() == '/Administrator/products/multibarcodeGenerate' || current_url() == '/product_ledger' || current_url() == '/productlist' || current_url() == '/product' ? 'open' : '' ?>">
				...
				<ul class="submenu">
					<?php if (array_search("product", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/product' ? 'active' : '' ?>" target="_blank">
			...
			<li class="<?= current_url() == '/area' || current_url() == '/unit' || current_url() == '/category' || current_url() == '/supplier' || current_url() == '/customer' ? 'open' : '' ?>">
				...
				<ul class="submenu">
					<?php if (array_search("customer", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/customer' ? 'active' : '' ?>" target="_blank">
					...
					<?php if (array_search("supplier", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/supplier' ? 'active' : '' ?>" target="_blank">
...
<?php } elseif ($module == 'SalesModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("chalan_entry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/chalan_entry' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>chalan_entry">
					<i class="menu-icon fa fa-plus-square"></i>
		...
		<?php if (array_search("chalan_record", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/chalan_record' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>chalan_record">
					<i class="menu-icon fa fa-list"></i>
...
<?php } elseif ($module == 'OrdersModule') { ?>
	<ul class="nav nav-list">
		...
		<li>
			<a href="<?php echo base_url(); ?>module/OrdersModule" class="module_title">
		...
		<?php if (array_search("sales", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/sales' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>orders">
					<i class="menu-icon fa fa-sort"></i>
		...
		<?php if (array_search("ordersrecord", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/ordersrecord' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>ordersrecord">
					<i class="menu-icon fa fa-list"></i>
...
<?php } elseif ($module == 'PurchaseModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("asset_name_entry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/asset_name_entry' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>asset_name_entry">
					<i class="menu-icon fa fa-shopping-cart"></i>
					<span class="menu-text"> Assets Name </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
...
<?php } elseif ($module == 'LcPurchaseModule') { ?>
	<ul class="nav nav-list">
		<li class="active">
			<a href="<?php echo base_url(); ?>module/dashboard">
				<i class="menu-icon fa fa-tachometer"></i>
		...
		<li>
			<a href="<?php echo base_url(); ?>module/LcPurchaseModule" class="module_title">
				<span> Lc Module </span>
			</a>
		</li>

		<?php if (array_search("lc_purchases", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/lc_purchases' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>lc_purchases">
					<i class="menu-icon fa fa-usd"></i>
					<span class="menu-text"> LC Entry </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("lc_purchaseRecord", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/lc_purchaseRecord' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>lc_purchaseRecord">
					<i class="menu-icon fa fa-list"></i>
					<span class="menu-text">LC Record</span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (array_search("lc_expanse", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/lc_expanse' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>lc_expanse">
					<i class="menu-icon fa fa fa-list"></i>
					<span class="menu-text"> Expense Name </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("lc_expanse_entry", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/lc_expanse_entry' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>lc_expanse_entry">
					<i class="menu-icon fa fa fa-list"></i>
		...
		<?php if (array_search("cbm_costing", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/cbm_costing' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>cbm_costing">
					<i class="menu-icon fa fa fa-cube"></i>
		...
		<!-- <?php if (array_search("duty_costing", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/duty_costing' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>duty_costing">
					<i class="menu-icon fa fa fa-ship"></i>
					<span class="menu-text"> P. Duty Costing </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?> -->
...
<?php } elseif ($module == 'AccountsModule') { ?>
	<ul class="nav nav-list">
		...
		<?php if (
			array_search("fdr_transactions", $access) > -1
			|| array_search("loan_transaction_report", $access) > -1
			|| array_search("fdr_accounts_view", $access) > -1
			|| array_search("fdr_accounts", $access) > -1
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)
		) : ?>

			<li class="<?= current_url() == '/fdr_accounts_view' || current_url() == '/loan_transaction_report' || current_url() == '/loan_ledger' || current_url() == '/fdr_accounts' || current_url() == '/fdr_transactions' ? 'open' : '' ?>">
				<a href="<?php echo base_url(); ?>" class="dropdown-toggle">
					<i class="menu-icon fa fa-file"></i>
				...
				<ul class="submenu">
					<?php if (array_search("fdr_transactions", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/fdr_transactions' ? 'active' : '' ?>">
							<a href="<?php echo base_url(); ?>fdr_transactions">
								<i class="menu-icon fa fa-caret-right"></i>
								FDR Transaction
							</a>
							<b class="arrow"></b>
					...
					<?php if (array_search("fdr_accounts_view", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/fdr_accounts_view' ? 'active' : '' ?>">
							<a href="<?php echo base_url(); ?>fdr_accounts_view">
								<i class="menu-icon fa fa-caret-right"></i>
								FDR Account View
							</a>
							<b class="arrow"></b>
					...
					<?php if (array_search("fdr_accounts", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/fdr_accounts' ? 'active' : '' ?>">
							<a href="<?php echo base_url(); ?>fdr_accounts">
								<i class="menu-icon fa fa-caret-right"></i>
								FDR Account
							</a>
							<b class="arrow"></b>
		...
		<?php if (
			...
			<li class="<?= current_url() == '/bank_accounts' || current_url() == '/account' ? 'open' : '' ?>">
				...
				<ul class="submenu">
					...
					<?php endif; ?>
					<?php if (array_search("sub_account", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/sub_account' ? 'active' : '' ?>">
							<a href="<?php echo base_url(); ?>sub_account">
								<i class="menu-icon fa fa-caret-right"></i>
								Transaction Sub Accounts
							</a>
							<b class="arrow"></b>
						</li>
					<?php endif; ?>
		...
		<?php if (
			...
			<li class="<?= current_url() == '/day_book' || current_url() == '/balance_sheet' || current_url() == '/BalanceSheet' || current_url() == '/cashStatment' || current_url() == '/bank_ledger' || current_url() == '/cash_ledger' || current_url() == '/bank_transaction_report' || current_url() == '/TransactionReport' ? 'open' : '' ?>">
				...
				<ul class="submenu">
					...
					<?php if (array_search("customer_payment_report", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/customer_payment_report' ? 'active' : '' ?>">
							<a href="<?php echo base_url(); ?>customer_payment_report">
								<i class="menu-icon fa fa-caret-right"></i>
								Customer Statement
							</a>
							<b class="arrow"></b>
...
<?php } elseif ($module == 'HRPayroll') { ?>
	<ul class="nav nav-list">
		...
		<?php if (array_search("salary_advance", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/salary_advance' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>salary_advance">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Salary Advance </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>

		<?php if (array_search("salary_conveyance", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
			<li class="<?= current_url() == '/salary_conveyance' ? 'active' : '' ?>">
				<a href="<?php echo base_url(); ?>salary_conveyance">
					<i class="menu-icon fa fa-money"></i>
					<span class="menu-text"> Salary Conveyance </span>
				</a>
				<b class="arrow"></b>
			</li>
		<?php endif; ?>
		...
		<?php if (
			...
			|| array_search("salary_conveyance_ledger", $access) > -1
			|| isset($CheckSuperAdmin) || isset($CheckAdmin)
		) : ?>
			<li class="<?= current_url() == '/salary_payment_report' || current_url() == '/emplists/deactive' || current_url() == '/emplists/active' || current_url() == '/emplists/all' ? 'open' : '' ?>">
				...
				<ul class="submenu">
					...
					<?php if (array_search("salary_conveyance_ledger", $access) > -1 || isset($CheckSuperAdmin) || isset($CheckAdmin)) : ?>
						<li class="<?= current_url() == '/salary_conveyance_ledger' ? 'active' : '' ?>">
							<a href="<?php echo base_url(); ?>salary_conveyance_ledger">
								<i class="menu-icon fa fa-caret-right"></i>
								Salary Conveyance Ledger
							</a>
							<b class="arrow"></b>
						</li>
					<?php endif; ?>
