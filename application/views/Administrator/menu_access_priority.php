...
<div id="userAccess">
    ...
    <div class="row" id="accessRow">
        <div class="col-md-3">
            <div class="group">
                <input type="checkbox" id="sales" class="group-head" @click="onClickGroupHeads"> <strong>Order</strong>
                <ul ref="sales">
                    <li><input type="checkbox" class="access" value="orders" v-model="access"> Order Entry</li>
                    <li><input type="checkbox" class="access" value="ordersrecord" v-model="access"> Order Record</li>
                </ul>
            </div>
            <div class="group">
                ...
                <ul ref="sales">
                    ...
                    <li><input type="checkbox" class="access" value="chalan_entry" v-model="access"> Chalan Entry</li>
                </ul>
            </div>
            ...
            <div class="group">
                ...
                <ul ref="accounts">
                    ...
                    <li><input type="checkbox" class="access" value="sub_account" v-model="access"> Transaction Sub Accounts</li>
            ...
            <div class="group">
                <input type="checkbox" id="FDR" class="group-head" @click="onClickGroupHeads"> <strong>FDR</strong>
                <ul ref="FDR">
                    <li><input type="checkbox" class="access" value="fdr_transactions" v-model="access"> FDR Transaction</li>
                    <li><input type="checkbox" class="access" value="fdr_accounts_view" v-model="access"> FDR Account View</li>
                    <li><input type="checkbox" class="access" value="fdr_accounts" v-model="access"> FDR Account</li>
                </ul>
            </div>
        </div>
        <div class="col-md-3">
            <div class="group">
                ...
                <ul ref="salesReports">
                    ...
                    <li><input type="checkbox" class="access" value="chalan_record" v-model="access"> Chalan Record</li>
                    <li><input type="checkbox" class="access" value="due_reminder" v-model="access"> Due Remainder</li>
                </ul>
            </div>
        ...
        <div class="col-md-3">
            ...
            <div class="group">
                <input type="checkbox" id="lc" class="group-head" @click="onClickGroupHeads"> <strong>LC</strong>
                <ul ref="lc">
                    <li><input type="checkbox" class="access" value="lc_purchases" v-model="access"> LC Entry</li>
                    <li><input type="checkbox" class="access" value="lc_purchaseRecord" v-model="access"> LC Record</li>
                    <li><input type="checkbox" class="access" value="lc_expanse" v-model="access"> LC Expense</li>
                </ul>
            </div>
            <div class="group">
                <input type="checkbox" id="hrPayroll" class="group-head" @click="onClickGroupHeads"> <strong>HR & Payroll</strong>
                <ul ref="hrPayroll">
                    <li><input type="checkbox" class="access" value="salary_advance" v-model="access">Advance Salary Payment</li>
                    <li><input type="checkbox" class="access" value="salary_conveyance" v-model="access">Salary Conveyance</li>
                    ...
                    <li><input type="checkbox" class="access" value="salary_conveyance_ledger" v-model="access"> Salary Conveyance Ledger</li>
                </ul>
            </div>
