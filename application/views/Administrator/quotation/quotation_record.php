				...
				<table class="record-table">
					...
					<tbody>
						<tr v-for="quotation in quotations">
							...
							<td style="text-align:start;">{{ quotation.SaleMaster_Description }}</td>
							<td style="text-align:center;">
								<a href="" v-bind:href="`/quotation_invoice/${quotation.SaleMaster_SlNo}`" title="View Invoice"><i class="fa fa-file"></i></a>
								<?php if ($this->session->userdata('accountType') != 'u') { ?>
									<a href="" v-bind:href="`/quotation/${quotation.SaleMaster_SlNo}`" title="Edit Quotation" target="_blank"><i class="fa fa-edit"></i></a>
