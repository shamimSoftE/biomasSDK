...
<div id="balanceSheet">
	...
	<div style="display:none;" v-bind:style="{display: showReport ? '' : 'none'}">
		...
		<div id="printContent">
			<div class="row">
				<div class="col-xs-6">
					<table class="balancesheet-table" v-if="recordType == 'with_details'">
						<thead>
							<tr>
								<td colspan="2">
									<h3>Asset</h3>
					...
					<table class="balancesheet-table" v-else>
						<thead>
							<tr>
								<td colspan="2">
									<h3>Asset</h3>
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:right;">
									{{ bank_accounts.reduce((prev, curr) => {return prev + parseFloat(curr.balance)}, 0).toFixed(2) }}
								</td>
							</tr>
							<tr>
								<th>Customer Due</th>
					...
					<table class="balancesheet-table" v-else>
						...
						<tbody>
							<tr>								
								<th>Investment:-</th>
								<td style="text-align:right;">
									{{ invest_accounts.reduce((prev, curr) => {return prev + parseFloat(curr.balance)}, 0).toFixed(2)}}
								</td>		
							</tr>
