				...
				<div class="col-md-12">
					<form action="" class="form-inline" @submit.prevent="getDayBookData">
						<div class="form-group" >
							...
							<select class="form-control" v-model="recordType" style="margin: 0;">
			...
			<div class="col-md-12">
				<div style="display:flex;">
					<div style="width:50%;border:1px solid black;position:relative;">
						<table class="day-book-table" v-if="recordType == 'with_details'">
							<thead>
								<tr>
									<th>Description</th>
									<th>Amount</th>
						...
						<table class="day-book-table" v-else>
							<thead>
								<tr>
									<th>Description</th>
									<th>Amount</th>
							...
							<tbody>
								...
								<template v-if="openingBalance.bankBalance.length > 0">
									...
									<template>
										<tr>
											<td>{{ openingBalance.bankBalance.reduce((pre, index) => { pre + parseFloat(index.balance)}, 0) }}</td>
										</tr>
									</template>
								</template>
								...
								<template v-if="sales.length > 0">
									...
									<tr>
										<td>{{ sales.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="asset_sales.length > 0">
									<tr>
									...
									<tr>
										<td>{{ asset_sales.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="receivedFromCustomers.length > 0">
									<tr>
									...
									<tr>
										<td>{{ receivedFromCustomers.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="cashReceived.length > 0">
									<tr>
									...
									<tr>
										<td>{{ cashReceived.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="receivedFromSuppliers.length > 0">
									<tr>
									...
									<tr>
										<td>{{ receivedFromSuppliers.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="loanInitials.length > 0">
									<tr>
									...
									<tr>
										<td>{{ loanInitials.reduce((pre, index) => { pre + parseFloat(index.initial_balance)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="loanReceives.length > 0">
									<tr>
									...
									<tr>
										<td>{{ loanReceives.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="investReceives.length > 0">
									<tr>
									...
									<tr>
										<td>{{ investReceives.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="bankWithdraws.length > 0">
									<tr>
									...
									<tr>
										<td>{{ bankWithdraws.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								...
								<template v-if="bankDeposits.length > 0">
									...
									<tr>
										<td>{{ bankDeposits.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
						...
						<table class="day-book-table" v-else>
							...
							<tbody>
								...
								<template v-if="purchases.length > 0">
									...
									<tr>
										<td>{{ purchases.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="asset_purchases.length > 0">
									<tr>
									...
									<tr>
										<td>{{ asset_purchases.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="paidToSuppliers.length > 0">
									<tr>
									...
									<tr>
										<td>{{ paidToSuppliers.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="cashPaid.length > 0">
									<tr>
									...
									<tr>
										<td>{{ cashPaid.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="paidToCustomers.length > 0">
									<tr>
									...
									<tr>
										<td>{{ paidToCustomers.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="employeePayments.length > 0">
									<tr>
									...
									<tr>
										<td>{{ employeePayments.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="loanPayments.length > 0">
									<tr>
									...
									<tr>
										<td>{{ loanPayments.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<template v-if="investPayments.length > 0">
									<tr>
									...
									<tr>
										<td>{{ investPayments.reduce((pre, index) => { pre + parseFloat(index.totalAmount)}, 0) }}</td>
									</tr>
								</template>
								<tr>
									<td class="main-heading">Closing Balance</td>
								...
								<template v-if="closingBalance.bankBalance.length > 0">
									...
									<template>
										...
										<tr>
											<td>{{ closingBalance.bankBalance.reduce((pre, index) => { pre + parseFloat(index.balance)}, 0) }}</td>
										</tr>
									</template>
								</template>
