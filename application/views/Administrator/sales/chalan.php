            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4 text-right">
                        <strong>Invoice by Name:</strong> {{ sales.AddBy }}<br>
                        <strong>Invoice No.:</strong> {{ sales.SaleMaster_InvoiceNo }}<br>
                        <strong>Sales Date:</strong> {{ formatDateTime(sales.SaleMaster_SaleDate, 'd m yy') }} {{ formatDateTime(sales.AddTime, 'h:mm a') }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-12" style="margin-top: 25px;">
                        <span> <strong>Note:</strong> {{ sales.SaleMaster_Description }}</span>
                    </div>
                </div>
            </div>
        </div>
