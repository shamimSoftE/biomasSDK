...
<div id="saleReturnList">
	<div class="row" style="margin:0;">
		<fieldset class="scheduler-border scheduler-search">
			<legend class="scheduler-border">Sales Retrun Details</legend>
			<div class="control-group">
				<div class="col-md-12">
					<form class="form-inline" id="searchForm" @submit.prevent="getSaleReturnDetails">
						...
						<div class="form-group">
							<input type="date" style="margin: 0;" class="form-control" v-model="dateFrom">
						</div>

						<div class="form-group">
							<input type="date" style="margin: 0;" class="form-control" v-model="dateTo">
						</div>
