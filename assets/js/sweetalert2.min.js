    ...
    Ft = function (t, e) {
      if (e.icon || e.iconHtml) {
        ...
        if (e.iconHtml) o = zt(e.iconHtml);
          ...
          o = '<i style="font-size:30px;" class="fa fa-exclamation-triangle"></i>';
        else if (e.icon) {
