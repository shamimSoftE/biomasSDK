const quotationInvoice = Vue.component('chalan-invoice', {
    template: `
        <div>
            <div class="row">
                <div class="col-xs-12">
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-8">
                        <strong>Customer Name:</strong> {{ chalan.SaleMaster_customer_name }}<br>
                        <strong>Customer Address:</strong> {{ chalan.SaleMaster_customer_address }}<br>
                        <strong>Customer Mobile:</strong> {{ chalan.SaleMaster_customer_mobile }}
                    </div>
                    <div class="col-xs-4 text-right">
                        <strong>Created by:</strong> {{ chalan.AddBy }}<br>
                        <strong>Invoice No.:</strong> {{ chalan.SaleMaster_InvoiceNo }}<br>
                        <strong>Date:</strong> {{ chalan.SaleMaster_SaleDate }} {{ moment(chalan.AddTime).format('h:mm a') }}
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                    ...
                    <div class="col-xs-6 col-xs-offset-6">
                        <table _t92sadbc2>
                            <tr>
                                ...
                                <td style="text-align:right">{{ chalan.SaleMaster_SubTotalAmount }}</td>
                            </tr>
                            <tr>
                                <td><strong>VAT:</strong></td>
                                <td style="text-align:right">{{ chalan.SaleMaster_TaxAmount }}</td>
                            </tr>
                            <tr>
                                <td><strong>Discount:</strong></td>
                                <td style="text-align:right">{{ chalan.SaleMaster_TotalDiscountAmount }}</td>
                            </tr>
                            <tr><td colspan="2" style="border-bottom: 1px solid #ccc"></td></tr>
                            <tr>
                                <td><strong>Total:</strong></td>
                                <td style="text-align:right">{{ chalan.SaleMaster_TotalSaleAmount }}</td>
                            </tr>
                        </table>
                    </div>
                </div>
    ...
    methods:{
        getChalans(){
            axios.post('/get_chalans', {chalanId: this.chalan_id}).then(res=>{
                ...
                <body>
                    ...
                    <div class="container" style="position:fixed;bottom:15px;width:100%;">
                        ...
                        <div class="row" style="font-size:12px;">
                            <div class="col-xs-6">
                                Print Date: ${moment().format('DD-MM-YYYY h:mm a')}, Printed by: ${this.chalan.AddBy}
                            </div>
                            <div class="col-xs-6 text-right">
                               <span style="display:none;"> Developed by: Link-Up Technologoy, Contact no: 01911978897 </span>
                            </div>
                        </div>
                    </div>
                </body>
