const lcInvoice = Vue.component("lc-invoice", {
    template: `
        <div>
            <div class="row">
                <div class="col-xs-12">
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    <div class="col-xs-7">
                        <strong>LC Date:</strong> {{ lc.AddTime }}                       
                    </div>
                </div>
                <div class="row">
                    <div class="col-xs-12">
                ...
                <div class="row">
                    <div class="col-xs-12">
                        <table _a584de>
                            ...
                            <tbody>
                                <tr>
                                    <td>{{ lc.account_name }}</td>
                                    <td>{{ lc.bank_name }}</td>
                                    <td>{{ lc.account_number }}</td>
                                    ...
                                    <td>{{ lc.paid }}</td>
                                    <td>{{ lc.due }}</td>
                                    <td align="right" v-if="lc.status == 'a'" style="font-size:14px; font-weight:bold; color:green; text-align:center;"> Approved</td>
                                    <td v-else style="font-size:14px; font-weight:bold; color:green; text-align:center;">Pending</td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-xs-6 m-auto">
                        <h5 style="margin-bottom:4px; margin-top:10px; text-align:center; font-weight:bold;"> Expenses Details</h5>
                        <table class="pull-left" _a584de>
                            <thead>
                            <tr>
                                <td> Expnenses Name </td>
                                <td> Pay Bill </td>
                            </tr>
                            </thead>
                            ...
                            <tbody> 
                                ...
                                <tr> 
                                    <td style="font-weight:bold; text-align: right;"> Total Expense Bill: </td>
                                    <td style="font-weight:bold;"> {{ expense = cart.reduce((prev,curr) => {return prev + parseFloat(curr.amount)}, 0) | decimal }} </td>
                                </tr>
                            </tbody>
                        </table>
                    </div>
                    ...
                    <div class="col-xs-12 m-auto">
                        <h5 style="margin-bottom:4px; margin-top:10px; text-align:center; font-weight:bold;"> Total LC Cost</h5> 
                        <div class="col-xs-12 m-auto">
                            <table class="pull-left" _a584de>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="font-weight:bold;"> {{ +productTotal +  +expense + +duty }}    </td>
                                </tr>
                            </table>
                        </div>
                    </div>
