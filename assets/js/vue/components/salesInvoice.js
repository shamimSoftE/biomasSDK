const salesInvoice = Vue.component('sales-invoice', {
            ...
            <div id="invoiceContent">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 text-right">
                        <strong>Invoice by:</strong> {{ sales.added_by }}<br>
    ...
    methods:{
        getSales(){
            axios.post('/get_sales', {salesId: this.sales_id,sale_type:'sale'}).then(res=>{
                    ...
                    <body>
                        <div class="container">
                            <table style="width:100%;">
                                <thead>
                                    <tr>
                                        <td>
                                            <div class="row">
                                                <div class="col-xs-12"><img src="/${this.currentBranch.header_image}" alt="Logo" style="height:100px; width:100%" /></div>
                                            </div>
                                            <div class="row">
                                                <div class="col-xs-12">
                                                    <div style="border-bottom: 4px double #454545;margin-top:7px;margin-bottom:7px;"></div>
                            ...
                            <div style="position:fixed;left:0;bottom:15px;width:100%;">
                                ...
                                <div class="row">
                                    <div class="col-xs-12"><img src="/${this.currentBranch.footer_image}" alt="Logo" style="height:100px; width:100%" /></div>
                                </div>
